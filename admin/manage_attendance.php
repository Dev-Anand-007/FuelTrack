                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            while ($employee = $employees->fetch()) {
                                                // Check if attendance for this employee has already been recorded for today
                                                $attendance = $conn->query("SELECT status FROM attendance WHERE employee_id = '{$employee['id']}' AND `date` = CURDATE()")->fetch();
