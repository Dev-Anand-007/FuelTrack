...
foreach ($record1 as $key1) { ?>
    ...
    <head>
        ...
        <meta content="Petrol pump management system" name="description" />
        <meta content="Minor Project" name="author" />
        <meta http-equiv="X-UA-Compatible" content="IE=edge" />
            ...
            <div class="sidebar-inner niceScrollleft">
                ...
                <div id="sidebar-menu">
                    <ul>
                        ...
                        <!-- Changes by anand -> Adding Employee Cell s1  -->
                        <li class="has_sub">
                            <a href="javascript:void(0);" class="waves-effect">
                            <i class="fa-solid fa-user-group"></i> <span>Employees</span> <span
